...
"use strict";
/* WEBPACK VAR INJECTION */(function(fetch) {/* unused harmony export promiseTimeout */
...
var post = function post() {
  ...
  var options = _objectSpread(_objectSpread(_objectSpread({}, defaultOptions), opts), {
    method: 'POST'
  });
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(18)["default"]))
...
module.exports = require("eccrypto");
...
// EXTERNAL MODULE: external "eccrypto"
var external_eccrypto_ = __webpack_require__(8);

// EXTERNAL MODULE: external "elliptic"
var external_elliptic_ = __webpack_require__(14);

// EXTERNAL MODULE: external "web3-utils"
var external_web3_utils_ = __webpack_require__(5);

// EXTERNAL MODULE: ./src/httpHelpers.js
var httpHelpers = __webpack_require__(1);

// EXTERNAL MODULE: external "loglevel"
var external_loglevel_ = __webpack_require__(16);
...
var external_json_stable_stringify_ = __webpack_require__(17);
...
var utils_keyLookup = function keyLookup(endpoints, verifier, verifierId) {
  var lookupPromises = endpoints.map(function (x) {
    return Object(httpHelpers["b" /* post */])(x, Object(httpHelpers["a" /* generateJsonRPCObject */])('VerifierLookupRequest', {
      verifier: verifier,
...
var utils_keyAssign = function keyAssign(endpoints, torusNodePubs, lastPoint, firstPoint, verifier, verifierId) {
  ...
  var data = Object(httpHelpers["a" /* generateJsonRPCObject */])('KeyAssign', {
    verifier: verifier,
    verifier_id: verifierId.toString()
  });
  return Object(httpHelpers["b" /* post */])('https://signer.tor.us/api/sign', data, {
    headers: {
    ...
    return (// eslint-disable-next-line promise/no-nesting
      Object(httpHelpers["b" /* post */])(endpoints[nodeNum], _objectSpread(_objectSpread({}, data), signedData), {
        headers: {
          'Content-Type': 'application/json; charset=utf-8'
        }
      })["catch"](function (_) {
...
var torus_Torus = /*#__PURE__*/function () {
  ...
  createClass_default()(Torus, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                tmpKey = Object(external_eccrypto_["generatePrivate"])();
                pubKey = Object(external_eccrypto_["getPublic"])(tmpKey).toString('hex');
                ...
                for (i = 0; i < endpoints.length; i += 1) {
                  p = Object(httpHelpers["b" /* post */])(endpoints[i], Object(httpHelpers["a" /* generateJsonRPCObject */])('CommitmentRequest', {
                    messageprefix: 'mug00',
                ...
                return _context2.abrupt("return", Some(promiseArr, function (resultArr) {
                  ...
                  for (var _i2 = 0; _i2 < endpoints.length; _i2 += 1) {
                    ...
                    var _p = Object(httpHelpers["b" /* post */])(endpoints[_i2], Object(httpHelpers["a" /* generateJsonRPCObject */])('ShareRequest', {
                      encrypted: 'yes',
                          ...
                          switch (_context.prev = _context.next) {
                              ...
                              for (_i3 = 0; _i3 < shareResponses.length; _i3 += 1) {
                                if (shareResponses[_i3] && shareResponses[_i3].result && shareResponses[_i3].result.keys && shareResponses[_i3].result.keys.length > 0) {
                                  ...
                                  if (shareResponses[_i3].result.keys[0].Metadata) {
                                    ...
                                    Object(external_eccrypto_["decrypt"])(tmpKey, torus_objectSpread(torus_objectSpread({}, metadata), {}, {
                            ...
                            case 11:
                              ...
                              _loop = function _loop(j) {
                                ...
                                var decryptedPubKey = Object(external_eccrypto_["getPublic"])(Buffer.from(derivedPrivateKey.toString(16, 64), 'hex')).toString('hex');
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return Object(httpHelpers["b" /* post */])("".concat(this.metadataHost, "/get"), data, options);
    ...
    value: function generateMetadataParams(message, privateKey) {
      ...
      var setData = {
        data: message,
        timestamp: new external_bn_js_default.a(Date.now()).toString(16)
      };
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                _context4.next = 3;
                return Object(httpHelpers["b" /* post */])("".concat(this.metadataHost, "/set"), data, options);
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 5:
                ...
                modifiedPubKey = _this2.ec.keyFromPublic({
                  x: X.toString(16),
                  y: Y.toString(16)
                }).getPublic().add(_this2.ec.keyFromPrivate(nonce.toString(16)).getPublic());
                X = modifiedPubKey.getX().toString(16);
                Y = modifiedPubKey.getY().toString(16);
                address = _this2.generateAddressFromPubKey(modifiedPubKey.getX(), modifiedPubKey.getY());
