...
abi:method.abi?[method.abi]:app.abi}},void 0),{abi,method}=foundMethod||{};let evaluatedNotice;if(method&&method.notice)try{evaluatedNotice=await radspec.evaluate(method.notice,{abi,transaction:intent},{ethNode:wrapper.web3.currentProvider})}catch(err){console.error(`Could not evaluate a description for given transaction data: ${intent.data}`,err)}return _objectSpread(_objectSpread({},intent),{},{description:evaluatedNotice})}/**
